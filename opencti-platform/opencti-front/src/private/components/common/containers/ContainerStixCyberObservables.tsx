...
import { ContainerStixCyberObservablesQuery, ContainerStixCyberObservablesQuery$variables } from '@components/common/containers/__generated__/ContainerStixCyberObservablesQuery.graphql';
